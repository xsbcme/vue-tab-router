  ...
  <div class="home-page">
    <section class="hero-section">
      <div class="hero-copy">
        ...
        <p class="hero-desc">面向后台管理系统、工作台和多文档编辑场景，把路由、标签页、缓存、守卫和 iframe 编排成一套稳定的页面工作流。</p>
      ...
      <div class="workspace-preview" aria-label="Vue Tab Router 工作台预览">
        ...
        <div class="preview-tabs">
          <div v-for="tab in previewTabs" :key="tab" class="preview-tab" :class="{ 'is-active': tab === '客户运营工作台' }">
            {{ tab }}
          </div>
        </div>
    ...
    <section class="scan-section">
      ...
      <div class="scan-layout">
        ...
        <div class="scan-list">
          ...
          <button v-for="view in featuredScanViews" :key="view.path" class="scan-row" type="button" @click="openScannedView(view)">
