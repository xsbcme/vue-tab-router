...
const contextAction = (eventName: string) => {
    ...
    if (!tab) return;
    switch (eventName) {
        case 'refresh':      tabsManager.refreshTab(tab._id); break;
        case 'close-left':   tabsManager.closeTabsByLeft(tab._id); break;
        case 'close-right':  tabsManager.closeTabsByRight(tab._id); break;
        case 'close-other':  tabsManager.closeTabsByOther(tab._id); break;
        case 'close-all':    tabsManager.closeTabByAll(); break;
        case 'refresh-all':  tabsManager.refreshTabAll(); break;
    }
};
</script>
