...
import { createTabsManager, StorageAdapter, TabViewUrl } from "@xsbcme/vue-tab-router";
    ...
    meta: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: "工作区切换动画", icon: "IconApps", viewUrl: "/src/views/learning/page-turn/page-index.vue" },
